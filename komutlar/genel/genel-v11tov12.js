...
exports.run = async (client, message, args) => {
  ...
  if (!v11Kod) {
    return message.channel.send(
      "Kodunu V12'ye Geçirmem İçin Kodunu Yazmalısın."
    );
  }
  if (v11Kod.length > 1800) {
    return message.channel.send(
      "Kodun 1800 Karakterden Fazla."
    );
  }
  let v12kod = v11Kod
    .split("get")
  ...
  if (v11Kod == v12kod) {
    return message.channel.send("Bu Kod V12 İle Uyumlu veya Geçerli Bir Komut Değil");
  }
